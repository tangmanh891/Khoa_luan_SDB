...
Khóa luận trình bày cải tiến theo hai bước tăng dần. \textbf{AutoShotV1} là bước tối giản nhất: giữ nguyên toàn bộ trọng số của AutoShot@F1 (mạng xương sống lẫn tầng phân loại) và chỉ bổ sung làm mượt Gaussian (Gaussian smoothing) ở khâu hậu xử lý --- không huấn luyện lại bất kỳ tham số nào, chỉ dò hệ số $\sigma$ trên tập xác thực. \textbf{AutoShotV2} là phiên bản đầy đủ: đóng băng mạng xương sống nhưng huấn luyện lại tầng phân loại với Focal Loss và nhãn nhiều điểm dương (many-hot), kết hợp hiệu chỉnh nhiệt độ (temperature scaling) và làm mượt Gaussian ở hậu xử lý. Kết quả định lượng của AutoShotV1 được trình bày ở Mục~\ref{sec:autoshotv1}; phần còn lại của mục này tập trung mô tả AutoShotV2.
