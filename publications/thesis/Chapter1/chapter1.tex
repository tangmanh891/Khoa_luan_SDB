...
\begin{itemize}
    ...
    \item \textbf{Đóng góp về kết quả thực nghiệm:} Trên tập SHOT, AutoShotV2 đạt F1 = \ASVTwoBestShotFOne{} theo cơ sở đánh giá của AutoShot, cải thiện $+\ASVTwoBestVsTransNetShotPP{}$ điểm phần trăm so với mô hình cơ sở TransNetV2; đồng thời cung cấp phân tích so sánh chéo trên BBC, ClipShots để đánh giá khả năng tổng quát hóa (chi tiết xem Chương~\ref{ch:bo_du_lieu_va_thuc_nghiem}).
\end{itemize}
