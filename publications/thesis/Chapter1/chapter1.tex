...
\begin{itemize}
    ...
    \item \textbf{Đóng góp về kết quả thực nghiệm:} Trên tập SHOT, AutoShotV2 đạt F1 = 0.8545 ($+5.5\%$ so với mô hình cơ sở TransNetV2); đồng thời cung cấp phân tích so sánh chéo trên BBC và ClipShots để đánh giá khả năng tổng quát hóa (chi tiết xem Chương~\ref{ch:ket_qua_thuc_nghiem}).
\end{itemize}
