...
Evaluation Protocol & Giao thức đánh giá: quy ước tính và báo cáo chỉ số. Trong khóa luận, F1 được lấy ở ngưỡng cho giá trị cao nhất trên từng bộ dữ liệu, đúng theo mã đánh giá gốc của AutoShot, để so sánh công bằng giữa các mô hình. \\
Heatmap Label & Nhãn mềm phân phối dạng Gaussian quanh vị trí ranh giới (thay cho nhãn một điểm dương), giúp mô hình bắt chuyển cảnh dần (\textit{gradual transition}) tốt hơn. \\
\bottomrule
\end{longtable}
}
