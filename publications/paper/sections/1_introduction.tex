...
With a fixed deployment configuration, AutoShotV2 achieves an F1 score of \PaperDeployShotFOne{} on the SHOT test set, corresponding to an improvement of \PaperDeployVsAutoShotPP{} percentage points over the reproduced AutoShot baseline. For comparison, an oracle threshold configuration reaches an F1 score of 0.8607 on SHOT (see Section~\ref{sec:oracle_sweep}). A controlled replication under a frozen,
validation-only
