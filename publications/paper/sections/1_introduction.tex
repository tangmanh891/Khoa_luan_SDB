...
Under per-dataset oracle threshold optimization, AutoShotV2 achieves a peak F1 score of 0.8607 on the SHOT test set, corresponding to an improvement of 2.02 percentage points over the reproduced AutoShot baseline of 0.8405 (see Section~\ref{sec:oracle_sweep}). A controlled replication under a frozen,
validation-only
...
0.8607 on SHOT under per-dataset oracle threshold optimization.
