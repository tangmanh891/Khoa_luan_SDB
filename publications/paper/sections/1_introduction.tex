...
With a fixed deployment configuration, AutoShotV2 achieves an F1 score of \PaperDeployShotFOne{} on the SHOT test set, improving over the reproduced AutoShot baseline by \PaperDeployVsAutoShotPP{} percentage points in F1 (reaching 0.8607 under peak sweep configuration). A controlled replication under a frozen,
validation-only
