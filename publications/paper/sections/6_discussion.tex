...
objection to single-run reports, is bounded below 0.5\% absolute F1 across
all three datasets by the three-seed study. The remaining unquantified term is protocol
