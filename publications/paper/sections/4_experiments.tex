...
\begin{table}[!t]
\caption{Protocol-Matched F1 Scores. B4 Is the Selected Method}
...
The study has four important limitations. First, the reported head was trained
with one seed; bootstrap intervals capture video sampling uncertainty but not
optimization variability. The revised runner fixes data seed 42 and schedules
training seeds 42, 43, and 44, but the original AutoShot base checkpoint needed
to execute those runs is not included in the present artifact bundle. Second,
