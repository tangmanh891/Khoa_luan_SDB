...
\textbf{Where the gain comes from.} The controlled ablation separates two
mechanisms that are often conflated. Training-side changes (Focal Loss,
many-hot supervision) leave the BCE control statistically unchanged, whereas
post-processing moves the operating point: Gaussian smoothing changes boundary
decisions and temperature scaling improves probability quality without
changing the ranking. For frozen-feature pipelines this ordering matters
