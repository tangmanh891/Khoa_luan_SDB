...
\textbf{Where the gain comes from.} The controlled ablation reframes the
training design space of Section~\ref{sec:objectives}. Focal Loss and
...
such as fitting a separate temperature on boundary-adjacent frames, is a
natural next step, but it requires an independent calibration split that the
